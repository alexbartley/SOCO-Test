CREATE OR REPLACE PROCEDURE content_repo.datacheck1_inzip4_notin_zip5 (aplha_zip4_statecodes out varchar2 )
is
vcnt number;
begin
...
loop
    ...
    then
         ...
         raise_application_error (-20201, 'datacheck1_inzip4_notin_zip5 data check failed, please correct the data');
    end if;
end loop;
end;
/