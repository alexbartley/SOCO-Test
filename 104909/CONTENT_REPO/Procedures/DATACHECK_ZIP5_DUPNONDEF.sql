CREATE OR REPLACE PROCEDURE content_repo.datacheck_zip5_dupnondef (aplha_zip4_statecodes out varchar2 )
is
vcnt number;
begin
...
loop
    ...
    then
         ...
         raise_application_error (-20201, 'datacheck_zip5_dupnondef data check failed, please correct the data');
    end if;
end loop;
end;
/