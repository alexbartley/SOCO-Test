CREATE OR REPLACE PROCEDURE content_repo.datacheck_inzip5_notin_zip4 (aplha_zip4_statecodes out varchar2 )
is
vcnt number;
begin
...
loop
    ...
    then
         ...
         raise_application_error (-20201, 'datacheck_inzip5_notin_zip4 data check failed, please correct the data');
    end if;
end loop;
end;
/