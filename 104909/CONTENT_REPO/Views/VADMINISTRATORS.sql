CREATE OR REPLACE FORCE VIEW content_repo.vadministrators ("ID",nkid,rid,next_rid,admin_rid,admin_next_rid,"NAME",description,requires_registration,collects_tax,administrator_type_id,administrator_type,start_date,end_date,status,status_modified_date,entered_by,entered_date) AS
SELECT ad.id,
       ad.nkid,
       ad.rid,
       ad.next_rid,
