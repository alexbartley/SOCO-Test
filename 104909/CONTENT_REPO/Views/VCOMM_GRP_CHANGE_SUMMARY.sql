CREATE OR REPLACE FORCE VIEW content_repo.vcomm_grp_change_summary ("ID",rid,nkid,status,published,modified,entered_by,table_name,reason,"SUMMARY",documents,veriftype) AS
SELECT ACL.ID,
            AR.ID,
            AR.NKID,
            ACL.STATUS,
