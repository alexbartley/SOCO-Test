CREATE OR REPLACE FORCE VIEW content_repo.vgeo_unique_area_summary (geo_unique_area_rid,geo_unique_area_nkid,change_count,document_count,published_date,is_editable,status) AS
SELECT ar.rid entity_rid,
       ...
       FROM vgeo_unique_area_rev_pk ar
            
            JOIN geo_unique_area_chg_logs clo
               ON (clo.rid = ar.rid)
