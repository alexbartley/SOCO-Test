CREATE OR REPLACE FORCE VIEW content_repo.vgeo_poly_rev_summary (geo_poly_rid,geo_poly_nkid,change_count,document_count,published_date,is_editable,status) AS
SELECT ar.rid entity_rid,
            ...
            ar.status
       FROM vgeo_poly_ref_rev_pk ar
            JOIN geo_poly_ref_chg_logs clo
               ON (clo.rid = ar.rid)
