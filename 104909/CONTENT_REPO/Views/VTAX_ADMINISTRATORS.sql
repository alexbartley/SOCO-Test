CREATE OR REPLACE FORCE VIEW content_repo.vtax_administrators ("ID",nkid,rid,next_rid,admin_id,admin_nkid,admin_rid,juris_tax_id,juris_tax_nkid,juris_tax_rid,administrator_name,collects_tax,collector_name,collector_id,collector_nkid,collector_rid,start_date,end_date,status,status_modified_date,entered_by,entered_date) AS
SELECT ta.id,
       ta.nkid,
       ta.rid,
       ta.next_rid,
