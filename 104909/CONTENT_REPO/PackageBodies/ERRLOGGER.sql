CREATE OR REPLACE PACKAGE BODY content_repo."ERRLOGGER"
IS
   g_target   PLS_INTEGER     := c_table;
   g_file     VARCHAR2 (2000) := 'errlogger.log';
   ...
   BEGIN
      ...
      IF reraise
      THEN
         errlogger.raise (errcode, errmsg);
      END IF;
   END;
   ...
   BEGIN
      ...
      THEN
         INSERT INTO errlog
                     (errcode, errmsg, entered_date, entered_by, stacktrace)
              VALUES (
                 l_sqlcode,
                 l_sqlerrm,
                 SYSDATE,
