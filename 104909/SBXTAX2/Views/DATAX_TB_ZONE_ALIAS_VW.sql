CREATE OR REPLACE FORCE VIEW sbxtax2.datax_tb_zone_alias_vw (data_check_id,datax_description,reviewed_approved,verified,"PATTERN","VALUE","TYPE",primary_key) AS
