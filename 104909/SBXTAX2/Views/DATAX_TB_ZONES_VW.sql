...
LEFT OUTER JOIN tb_zone_levels zl2 ON (zl2.zone_level_id = NVL(z.zone_2_level_id,-1000))
LEFT OUTER JOIN tb_zone_levels zl3 ON (zl3.zone_level_id = NVL(z.zone_3_level_id,-1000))
