CREATE OR REPLACE PROCEDURE sbxtax2.DATAX_TB_RULES_41
...
BEGIN
    ...
    AND nvl(childRule.code,'XXXXXXX') = nvl(parentRule.code,'XXXXXXX') /* added new restriction to match up Rules by Tax Code 06/20/2012*/
    AND NOT EXISTS(
        SELECT 1
