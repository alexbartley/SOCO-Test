CREATE OR REPLACE PROCEDURE sbxtax2.datax_run_custom_execution(inputString IN VARCHAR2, taxDataProvider IN VARCHAR2)
   IS
   runId NUMBER;
...
BEGIN
    ...
    FOR dc IN custom_queue LOOP
        IF dc.data_check_id NOT IN (-711,-716,-749,-755,-758,-759,-623,-639,-746) THEN
