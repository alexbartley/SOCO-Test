CREATE OR REPLACE PROCEDURE sbxtax2.datax_tb_rules_117_1
   ( taxDataProviderId IN NUMBER, runId IN OUT NUMBER)
   IS
   --<data_check id="117.1" name="Duplicate Product Rules" >
   dataCheckId NUMBER := -709;
BEGIN
    INSERT INTO datax_records (recorded_message, run_id)
    VALUES ('DATAX_TB_RULES_117_1 started.',runId) RETURNING run_id INTO runId;
    COMMIT;
    ...
    INSERT INTO datax_records (recorded_message, run_id)
    VALUES ('DATAX_TB_RULES_117_1 finished.',runId);
    COMMIT;
END;
