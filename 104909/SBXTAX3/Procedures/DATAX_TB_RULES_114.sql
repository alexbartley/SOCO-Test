CREATE OR REPLACE PROCEDURE sbxtax3.datax_tb_rules_114
...
BEGIN
    ...
    AND r.rule_comment NOT IN ('ORACLE[XVAT]','ORACLE[FROD]','ORACLE[GUST]','ORACLE[MYVT]','ORACLE[ZVAT]','ORACLE[PKST]','ORACLE[RSST]','ORACLE[VIST]')
    AND NOT EXISTS (
        SELECT 1
