CREATE OR REPLACE FORCE VIEW sbxtax3.datax_tb_zones_vw (data_check_id,reviewed_approved,verified,record_key,zone_1_name,zone_2_name,zone_2_level,zone_3_name,zone_3_level,zone_4_name,zone_4_level,zone_5_name,zone_5_level,zone_6_name,zone_6_level,zone_7_name,zone_7_level,is_bottom_up,terminates_processing,default_flag,code_2char,code_3char,code_iso,code_fips,primary_key) AS
...
o.primary_key
FROM datax_checks c
JOIN datax_check_output o ON (o.data_check_id = c.data_Check_id AND c.data_owner_table = 'TB_ZONES')
JOIN ct_zone_Tree z ON (z.primary_key = o.primary_key)
LEFT OUTER JOIN tb_zone_levels zl2 ON (zl2.zone_level_id = z.zone_2_level_id)
...
WHERE c.data_owner_table = 'TB_ZONES'
