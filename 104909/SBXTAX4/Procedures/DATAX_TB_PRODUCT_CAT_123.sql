CREATE OR REPLACE PROCEDURE sbxtax4."DATAX_TB_PRODUCT_CAT_123"
...
BEGIN
    ...
    SELECT primary_key, dataCheckId, runId, SYSDATE
        ...
        select pt.primary_key, COUNT(*) OVER (PARTITION BY pt.product_1_name, pt.product_2_name, pt.product_3_name, pt.product_4_name,
            pt.product_5_name, pt.product_6_name, pt.product_7_name, pt.product_8_name, pt.product_9_name) count_of
