CREATE OR REPLACE PROCEDURE sbxtax4."CT_REP_AUTHBY"
   ...
   IS
    ...
    'Authority_Name,Official_Name,Location_Code,Authority_Type,Admin_Level,Authority_Category,Erp_Tax_Code,Registration_Mask';
    authTypeId NUMBER;
    zoneLevelId NUMBER;
BEGIN
    ...
    FOR r IN (
        SELECT a.name Authority_Name, a.official_name, a.location_Code, aty.name authority_Type, az.name admin_level, a.authority_category, a.erp_tax_code, a.registration_mask
        FROM tb_authorities a, tb_merchants m, tb_Zone_levels az, tb_Authority_types aty
