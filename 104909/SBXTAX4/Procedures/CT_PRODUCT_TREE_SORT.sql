CREATE OR REPLACE PROCEDURE sbxtax4."CT_PRODUCT_TREE_SORT"
   IS
...
BEGIN
    ...
    INSERT INTO pt_temp_product_Tree_sort (branch_sort, product_Category_id
        ...
        SELECT LPAD(COUNT(*) OVER (PARTITION BY parent_product_category_id ORDER BY UPPER(NAME)),5,'0') branch_sort, product_category_id
