CREATE OR REPLACE PROCEDURE sbxtax4."CT_REP_AZMSK"
   ...
   IS
    ...
    'Authority_Name,zone_1_name,zone_2_name,zone_3_name,zone_4_name,zone_5_name,zone_6_name,zone_7_name,fips,bottom_up_terminates';
...
BEGIN
    ...
    FOR r IN (
        SELECT authority_name, zone_1_name, zone_2_name, zone_3_name, zone_4_name, zone_5_name, zone_6_name, zone_7_name, za.code_fips, NVL(za.reverse_flag,'N') reverse_flag
        ...
        ORDER BY zone_4_name, zone_5_name, zone_6_name, zone_7_name, authority_name
        ) LOOP
        fileLine :=
            '"'||r.Authority_Name||'",'||
            r.zone_1_name||','||
