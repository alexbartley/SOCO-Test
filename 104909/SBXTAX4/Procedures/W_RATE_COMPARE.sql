CREATE OR REPLACE PROCEDURE sbxtax4."W_RATE_COMPARE" (filename IN varchar2, extract_date IN varchar2, state varchar2) is

ftype utl_file.file_type;
begin
ftype := utl_file.fopen('E:\TEMP', filename, 'W');
...
from (
select  'UNITED STATES' Country, full_address.zone_3_name State_Province, full_address.zone_4_name County, full_address.zone_5_name City, full_address.zone_6_name ZipCode, full_address.zone_7_name GeoCode,
