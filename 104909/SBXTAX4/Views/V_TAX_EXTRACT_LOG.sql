CREATE OR REPLACE FORCE VIEW sbxtax4.v_tax_extract_log (nkid,rid,official_name,reference_code,queued_date,extract_date,transformed,not_transformed,loaded,not_loaded) AS
