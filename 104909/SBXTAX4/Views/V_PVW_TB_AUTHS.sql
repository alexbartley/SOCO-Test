CREATE OR REPLACE FORCE VIEW sbxtax4.v_pvw_tb_auths (jurisdiction_nkid,uuid,"NAME",location_code,official_name,description,authority_category,authority_type,admin_zone_level,effective_zone_level,default_prod_group,registration_mask) AS
