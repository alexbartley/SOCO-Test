CREATE OR REPLACE FORCE VIEW sbxtax4.v_pvw_tb_rates (result_type,authority,rate_code,start_date,end_date,rate,split_type,split_amount_type,flat_fee,description,is_local,tier_amount_low,tier_amount_high,tier_rate,tier_rate_code,tier_flat_fee) AS
...
from pvw_tb_rates r
left outer join pvw_tb_rate_tiers rt on (rt.rate_code = r.rate_code and rt.authority_uuid = r.authority_uuid and r.is_local = rt.is_local and r.start_date =rt.start_date)
