CREATE OR REPLACE FORCE VIEW sbxtax4.datax_tb_zone_auth_vw (data_check_id,reviewed_approved,verified,datax_description,record_key,zone_1_name,zone_2_name,zone_2_level,zone_3_name,zone_3_level,zone_4_name,zone_4_level,zone_5_name,zone_5_level,zone_6_name,zone_6_level,zone_7_name,zone_7_level,authority_name,primary_key,approve_date) AS
SELECT c.data_check_id, o.reviewed_Approved||' '||to_char(o.approved_date,'DD-Mon-yyyy') reviewed_Approved, o.verified||' '||to_char(o.verified_date,'DD-Mon-yyyy'), c.description datax_description,
