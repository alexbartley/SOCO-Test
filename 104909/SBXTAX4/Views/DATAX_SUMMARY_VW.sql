CREATE OR REPLACE FORCE VIEW sbxtax4.datax_summary_vw ("PRIORITY",former_id,data_check_id,"CATEGORY",data_check_desc,plan_name,last_run,new_unapproved_count,prex_approved_count) AS
