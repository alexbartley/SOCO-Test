CREATE OR REPLACE FORCE VIEW sbxtax4.datax_re_reported_vw (data_check_name,data_check_description,flag_level_id,data_check_id,original_run_id,run_id) AS
