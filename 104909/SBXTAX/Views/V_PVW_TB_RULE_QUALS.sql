CREATE OR REPLACE FORCE VIEW sbxtax.v_pvw_tb_rule_quals (authority,uuid,rule_order,rate_code,"EXEMPT",no_tax,start_date,end_date,code,tax_type,is_local,"ELEMENT","VALUE",rq_start_date,rq_end_date,"OPERATOR",reference_list_name,rq_authority,rq_authority_uuid,rule_qualifier_type) AS
