CREATE OR REPLACE FORCE VIEW sbxtax.datax_tb_rates_vw (data_check_id,reviewed_approved,verified,record_key,authority_name,rate_code,start_date,end_date,flat_fee,rate,split_type,split_amount_type,description,tier_low,tier_high,tier_rate,tier_rate_code,primary_key,approved_date) AS
