CREATE OR REPLACE FORCE VIEW sbxtax.v_pvw_tb_zones (zone_id,"NAME",parent_zone_id,parent_name,code_fips,zone_3_name,zone_4_name,zone_5_name,zone_6_name,zone_7_name,reverse_flag,terminator_flag,default_flag,tree_type) AS
SELECT  DISTINCT
        p.zone_id
        ,p.NAME
        ,p.parent_zone_id
