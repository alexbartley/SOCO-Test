CREATE OR REPLACE FORCE VIEW sbxtax.v_pvw_tb_zone_auths (state_code,zone_id,authority_id,authority_name,zone_3_name,zone_4_name,zone_5_name,zone_6_name,zone_7_name,tree_type) AS
SELECT  DISTINCT 
        p.state_code
        , p.zone_id
        , p.authority_id
