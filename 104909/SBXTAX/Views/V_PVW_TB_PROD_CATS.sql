CREATE OR REPLACE FORCE VIEW sbxtax.v_pvw_tb_prod_cats (result_type,product_category_id,nkid,product_group,prodcode,"NAME",description,product_1_name,product_2_name,product_3_name,product_4_name,product_5_name,product_6_name,product_7_name,product_8_name,product_9_name,product_10_name) AS
