CREATE OR REPLACE PROCEDURE sbxtax.ct_populate_zone_tree
   IS
   ...
   lChar VARCHAR2(1);
   pChar VARCHAR2(1);
   selectColumns VARCHAR2(1000) := 'z.zone_id, z.name, zone_level_id, sysdate creation_date, z.zone_id primary_key, z.merchant_id, z.eu_zone_as_of_date, z.code_2char, z.code_3char, z.code_iso, z.code_fips, z.reverse_flag, z.terminator_flag, z.default_flag, z.range_min, z.range_max, z.eu_exit_date, z.gcc_as_of_date, z.gcc_exit_date '; -- crapp-4205, added "z." to new GCC columns
   insertColumns VARCHAR2(1000) := 'tax_parent_zone, zone_1_id, zone_1_name, zone_1_level_id,creation_date, primary_key, merchant_id, eu_zone_as_of_date, code_2char, code_3char, code_iso, code_fips, reverse_flag, terminator_flag, default_flag, range_min, range_max, eu_exit_date, gcc_as_of_date, gcc_exit_date ';
   tax_parent_sql VARCHAR2(1000) := 'decode(z.tax_parent_zone_id, zone_1_id, zone_1_name, zone_2_id, zone_2_name, zone_3_id, zone_3_name, zone_4_id ,zone_4_name, zone_5_id ,zone_5_name, zone_6_id, zone_6_name, zone_7_id, zone_7_name, null) ';
...
BEGIN
   ...
   insertSql := 'INSERT INTO ct_zone_tree ('||insertColumns||') (SELECT null tax_parent_zone, '||selectColumns||
    ' FROM tb_Zones z '||
   ...
   COMMIT;
    ...
    COMMIT;
    --Add/include Tax_Parent_Zone in the SELECT
    selectColumns := tax_parent_sql||' tax_parent_zone, '||selectColumns;
